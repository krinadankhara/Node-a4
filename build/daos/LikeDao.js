...
class LikeDao {
    constructor() {
        this.findAllUsersThatLikedTuit = (tid) => __awaiter(this, void 0, void 0, function* () {
            return LikeModel_1.default.find({ tuit: tid }).populate("likedBy").exec();
        });
        this.findAllTuitsLikedByUser = (uid) => __awaiter(this, void 0, void 0, function* () {
            return LikeModel_1.default.find({ likedBy: uid }).populate({
                path: "tuit",
                populate: {
                    path: "postedBy"
                }
        ...
        this.userLikesTuit = (uid, tid) => __awaiter(this, void 0, void 0, function* () {
            return LikeModel_1.default.create({ tuit: tid, likedBy: uid });
        });
