...
class TuitController {
    constructor() {
        ...
        this.findAllTuitsByUser = (req, res) => {
            ...
            try {
                TuitController.tuitDao.findAllTuitsByUser(userId).then((tuits) => res.json(tuits));
            }
            catch (e) {
                console.log(e);
            }
        ...
        this.createTuitByUser = (req, res) => {
            ...
            let userId = req.params.uid === "me" && req.session['profile'] ? req.session['profile']._id : req.params.uid;
            try {
                TuitController.tuitDao.createTuitByUser(userId, req.body).then((tuit) => res.json(tuit));
            }
            catch (e) {
                console.log(e);
            }
         ...
         */
        this.updateTuit = (req, res) => TuitController.tuitDao.updateTuit(req.params.tid, req.body).then((status) => res.send(status));
        /**
         ...
         */
        this.deleteTuit = (req, res) => TuitController.tuitDao.deleteTuit(req.params.tid).then((status) => res.send(status));
    }
}
