...
class LikeController {
    constructor() {
         ...
         */
        this.findAllUsersThatLikedTuit = (req, res) => LikeController.likeDao.findAllUsersThatLikedTuit(req.params.tid).then((likes) => res.json(likes));
        /**
         ...
         * database
         */
        this.userLikesTuit = (req, res) => LikeController.likeDao.userLikesTuit(req.params.uid, req.params.tid).then((like) => res.json(like));
        /**
         * Removes like instance from the database representing that the user unliked the tuit
         * @param {Request} req Represents request from client, including the
         ...
         */
        this.userUnlikesTuit = (req, res) => LikeController.likeDao.userUnlikesTuit(req.params.uid, req.params.tid).then(status => res.send(status));
        /**
         * @param {Request} req Represents request from client, including the
         * path parameters uid and tid representing the user that is liking the tuit
         * and the tuit being liked
        ...
        this.userTogglesTuitLikes = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const userAlreadyDislikedTuit = yield LikeController.dislikeDao.findUserDislikesTuit(userId, tid);
